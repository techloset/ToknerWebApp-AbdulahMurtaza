  ...
  return (
    <div className="md:px-10 p-4 2xl:px-44 font-['Century_Gothic'] bg-[#0F1320]">
      <div className="grid md:grid-cols-2 gap-5 mt-[50px] sm:mt-12 ">
        {/* First Card */}
        <div className="bg-[#171b29] flex flex-[1 1 48%] py-8 md:py-10 px-8 2xl:px-16 text-start rounded-3xl flex-col justify-between items-start gap-8 md:mb-20 2xl:py-16 2xl:max-w-[777px] 2xl:max-h-[436px]">
        ...
        {/* Second Card */}
        <div className="bg-[#171b29] flex flex-[1 1 48%] py-8 md:py-10 px-8 2xl:px-16 text-start rounded-3xl flex-col justify-between items-start gap-8 md:mt-20 2xl:py-16 2xl:max-w-[777px] 2xl:max-h-[436px]">
          <div className="self-stretch flex flex-col justify-between gap-5 items-start">
            <div
