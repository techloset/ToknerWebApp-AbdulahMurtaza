      ...
      <section>
        <>
          <div className="grid  pt-[70px] sm:mt-12 grid-cols-1 md:grid-cols-2">
            ...
            <div className="flex flex-col h-[700px] md:h-auto sm-pt-0 md:justify-around items-center pt-16 relative overflow-x-hidden bg-white rounded-tr-[220px] md:rounded-tr-none md:rounded-tl-[160px] lg:rounded-tl-[280px]">
              <div className="w-4/5">
                <div className="text-gray-900 text-2xl sm:mt-0 lg:mt-10 mt-10  xl:text-5xl font-bold  ">
                  What makes us different?
                </div>
                <p className="text-gray-900 xl:text-base text-xs font-bold  leading-5 opacity-60">
                  We would only launch tokens with the express permission of the
                  creators.
                </p>
                <p className="text-gray-900  w-auto md:w-auto  xl:text-base text-xs  leading-6  opacity-60">
