...
function PreSale() {
  return (
    <>
      <div className="preSaleBgImage h-[1150px] md:block hidden font-['Century_Gothic']">
        <h2 className="text-5xl text-center font-bold text-white mt-24 mb-6 pt-[320px]">
          Presale Details
        </h2>
        <div className="grid grid-cols-3 gap-2 xl:gap-8 mx-12 xl:mx-32">
          {/* Card 1 */}
          <div className="card bg-white text-gray-900 font-bold rounded-3xl max-w-[511px] max-h-[585px] text-center py-16 mb-10">
            <div
          ...
          {/* End Card 1 */}
          {/* Card 2 */}
          <div className="card bg-white text-gray-900 font-bold rounded-3xl max-w-[511px] max-h-[585px] text-center py-16 mt-10">
            <div
              className="bg-image py-3"
              style={{
        ...
        >
          <SwiperSlide className="min-h-[550px]">
            ...
            <div className="card bg-white text-gray-900 font-bold rounded-3xl max-w-[511px] max-h-[585px] text-center py-16">
              ...
              <div className=" text-xl  leading-5 mt-16">
                1 BNB = 100000 WNTR
              </div>
              <div className="text-base font-normal leading-5">
                Soft cap:{" "}
