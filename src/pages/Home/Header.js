    ...
    >
      ...
      <div>
        <div className="grid md:grid-cols-12 justify-between">
          <div className="ms-4 md:mt-40 md:ms-36 sm:ms-2 2xl:ms-[189px] col-span-5 text-start">
            <div className="mt-16 bg-gradient-to-t from-[#2B3087] to-[#00B4EC] bg-clip-text text-transparent font-bold text-sm 2xl:text-base">
              At Tokners We Are
            </div>
            <div className="mt-4 text-[#fff] leading-[44px] font-bold text-4xl 2xl:text-5xl xl:pr-4 2xl:pr-7">
          ...
          <div
            className="lg:hidden h-[400px] col-span-12 w-screen"
            style={{
          ...
          ></div>
          <div className="itemImg md:mt-14 col-span-7 2xl:mt-20 hidden lg:block">
            <img
              src="https://res.cloudinary.com/dtqdflngh/image/upload/v1693553213/mainImg_zgfsaz.png"
